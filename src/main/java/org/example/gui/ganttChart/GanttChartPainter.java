package org.example.gui.ganttChart;
...
public class GanttChartPainter extends JFrame {
    ...
    public GanttChartPainter(String title, ArrayList<GanttChartSection> ganttChartData) {
        super(title);
