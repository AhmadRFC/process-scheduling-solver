...
import org.example.algorithms.GanttChartSection;
import org.example.gui.ganttChart.GanttChartPainter;
...
public class TableResults extends JFrame implements ActionListener {
    ...
    public TableResults(String title, ArrayList<Process> processes,
            ArrayList<GanttChartSection> ganttChartData, double avgTurnaroundTime,
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == closeButton) {
            ...
            GanttChartPainter gantChartPainter = new GanttChartPainter("Gantt Chart", ganttChartData);
    ...
    public static void sampleData(DataSet data, ArrayList<org.example.Process> processes) {
